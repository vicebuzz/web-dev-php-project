  ...
  <main>
    <div class="my-desk-section"> 
      ...
      <section class="activities-section">
        ...
        <div class="activity-cards">
          ...
          <div class="activity-card">
            ...
            <button class="register-btn">JOIN</button>
          </div>
      ...
      <section class="activities-section">
        ...
        <p class="activities-description">View and Delete an Activity</p>
        <!-- View and Remove Existing Activities -->
        <div class="activity-card admin-activity-card">
          <div class="activity-list">
            <!-- Display existing activities dynamically added using PHP or backend -->
            <!-- Sample activity card for representation -->
            <!-- Add more existing activity cards as needed -->
          </div>
        </div>
      </section>
